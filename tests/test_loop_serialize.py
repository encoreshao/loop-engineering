...
from loop_serialize import find_latest_result, list_results, read_result, to_json_dict, write_result
from loop_state import LoopState
from loop_verifiers import VerificationResult


def _sample_result(run_id="run_1", loop_id="loop_1"):
    ...
    iteration = IterationResult(
        ...
        budget={"overall": BudgetStatus.OK},
        progressed=True,
    )
    return LoopResult(
        loop_id=loop_id,
